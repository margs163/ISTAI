...
export default function AllTestsHeader() {
  return (
    <section className="w-full flex flex-row font-geist justify-between items-center py-2 lg:py-4 px-6 lg:px-8 rounded-lg bg-transparent border-slate-200/80">
