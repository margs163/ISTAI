    ...
    <div className="max-w-[800px] flex flex-col gap-10 px-6">
      ...
      <section>
        ...
        <RegularLegalParagraph>
          ...
          through advanced AI simulations. Offering personalized, interactive
          practice sessions, it helps users build confidence, improve fluency,
          and master natural conversation for exam success.
        </RegularLegalParagraph>
        <RegularLegalParagraph>
        ...
        <RegularLegalParagraph>
          We recomment that you print a copy of these Legal Terms for your
          records.
        </RegularLegalParagraph>
      </section>
      <section>
        ...
        <LegalBullitList className="list-decimal">
          <LegalBullitLi className="uppercase">
            <a href="#our-services" className="link-legal">
              OUR SERVICES
            </a>
          </LegalBullitLi>
          <LegalBullitLi className="uppercase">
            <a href="#intellectual-rights" className="link-legal">
              INTELLECTUAL PROPERTY RIGHTS
            </a>
          </LegalBullitLi>
          <LegalBullitLi className="uppercase">
            <a href="#representations" className="link-legal">
          ...
          <LegalBullitLi className="uppercase">
            <a href="#purchases" className="link-legal">
              PURCHASES AND PAYMENT
            </a>
          </LegalBullitLi>
          <LegalBullitLi className="uppercase">
            <a href="#subscriptions" className="link-legal">
              SUBSCRIPTIONS
            </a>
          </LegalBullitLi>
          <LegalBullitLi>
            <a href="#prohibited-activities" className="link-legal">
              PROHIBITED ACTIVITIES
            </a>
          </LegalBullitLi>
          <LegalBullitLi>
            <a href="#generated-contributions" className="link-legal">
              USER GENERATED CONTRIBUTIONS
            </a>
          </LegalBullitLi>
          <LegalBullitLi>
            <a href="#contributions-license" className="link-legal">
              CONTRIBUTIONS LICENSE
            </a>
          </LegalBullitLi>
          <LegalBullitLi>
            <a href="#reviews-guidelines" className="link-legal">
              GUIDELINES FOR REVIEWS
            </a>
          </LegalBullitLi>
          <LegalBullitLi>
            <a href="#third-party" className="link-legal">
              THIRD-PARTY WEBSITES AND CONTENT
            </a>
          </LegalBullitLi>
          <LegalBullitLi>
            <a href="#services-management" className="link-legal">
              SERVICES MANAGEMENT
            </a>
          </LegalBullitLi>
          <LegalBullitLi>
            <a href="#privacy-policy" className="link-legal">
              PRIVACY POLICY
            </a>
          </LegalBullitLi>
          <LegalBullitLi>
            <a href="#copyright-infringements" className="link-legal">
              COPYRIGHT INFRINGEMENTS
            </a>
          </LegalBullitLi>
          <LegalBullitLi>
            <a href="#termination" className="link-legal">
              TERM AND TERMINATION
            </a>
          </LegalBullitLi>
          <LegalBullitLi>
            <a href="#modifications" className="link-legal">
              MODIFICATIONS AND INTERRUPTIONS
            </a>
          </LegalBullitLi>
          <LegalBullitLi>
            <a href="#governing-law" className="link-legal">
              GOVERNING LAW
            </a>
          </LegalBullitLi>
          <LegalBullitLi>
            <a href="#corrections" className="link-legal">
              CORRECTIONS
            </a>
          </LegalBullitLi>
          <LegalBullitLi>
            <a href="#disclaimer" className="link-legal">
              DISCLAIMER
            </a>
          </LegalBullitLi>
          <LegalBullitLi>
            <a href="#limitations" className="link-legal">
              LIMITATIONS OF LIABILITY
            </a>
          </LegalBullitLi>
          <LegalBullitLi>
            <a href="#indemnification" className="link-legal">
              INDEMNIFICATION
            </a>
          </LegalBullitLi>
          <LegalBullitLi>
            <a href="#user-data" className="link-legal">
              USER DATA
            </a>
          </LegalBullitLi>
          <LegalBullitLi>
            <a href="#electronic" className="link-legal">
              ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES
            </a>
          </LegalBullitLi>
          <LegalBullitLi>
            <a href="#miscellaneous" className="link-legal">
              MISCELLANEOUS
            </a>
          </LegalBullitLi>
          <LegalBullitLi>
      ...
      <section id="our-services">
        <RegularLegalHeader>1. OUR SERVICES</RegularLegalHeader>
        <RegularLegalParagraph>
      ...
      <section id="intellectual-rights">
        <RegularLegalHeader>2. INTELLECTUAL PROPERTY RIGHTS</RegularLegalHeader>
        <RegularLegalSmallHeader>
        ...
        <RegularLegalParagraph>
          ...
          please address your request to: aldanovdaniyal@gmail.com If we ever
        ...
        <LegalBullitList
          description={`You are responsible for what you post or upload: By sending us Submissions and/or posting Contributions through any part of the Services or making Contributions accessible through the Services by linking your account through the Services to any of your social networking accounts, you:`}
        >
          <LegalBullitLi>
      ...
      <section id="representations">
        <RegularLegalHeader>3. USER REPRESENTATIONS</RegularLegalHeader>
        <RegularLegalParagraph>
      ...
      <section id="share-information">
        <RegularLegalHeader>4. USER REGISTRATION</RegularLegalHeader>
        <RegularLegalParagraph>
      ...
      <section id="purchases">
        <RegularLegalHeader>5. PURCHASES AND PAYMENT</RegularLegalHeader>
        <LegalBullitList description="We accept the following forms of payment:">
          <LegalBullitLi>Mastercard</LegalBullitLi>
          <LegalBullitLi>Visa</LegalBullitLi>
          <LegalBullitLi>American Express</LegalBullitLi>
        </LegalBullitList>
        <RegularLegalParagraph>
      ...
      <section id="subscriptions">
        <RegularLegalHeader>6. SUBSCRIPTIONS</RegularLegalHeader>
        <RegularLegalSmallHeader>Billing and Renewal</RegularLegalSmallHeader>
        <RegularLegalParagraph>
        ...
        <RegularLegalSmallHeader>Cancellation</RegularLegalSmallHeader>
        <RegularLegalParagraph>
        ...
        <RegularLegalSmallHeader>Fee Changes</RegularLegalSmallHeader>
        <RegularLegalParagraph>
      ...
      <section id="prohibited-activities">
        <RegularLegalHeader>7. PROHIBITED ACTIVITIES</RegularLegalHeader>
        <RegularLegalParagraph>
        ...
        <LegalBullitList description="As a user of the Services, you agree not to:">
          <LegalBullitLi>
      ...
      <section id="contributions-license">
        <RegularLegalHeader>9. CONTRIBUTIONS LICENSE</RegularLegalHeader>
        <RegularLegalParagraph>
      ...
      <section id="reviews-guidelines">
        <RegularLegalHeader>10. GUIDELINES FOR REVIEWS</RegularLegalHeader>
        <RegularLegalParagraph>
      ...
      <section id="services-management">
        <RegularLegalHeader>12. SERVICES MANAGEMENT</RegularLegalHeader>
        <RegularLegalParagraph>
      ...
      <section id="privacy-policy">
        <RegularLegalHeader>13. PRIVACY POLICY</RegularLegalHeader>
        <RegularLegalParagraph>
          We care about data privacy and security. Please review our Privacy
          Policy: https://fluentflow.space. By using the Services, you agree to
          be bound by our Privacy Policy, which is incorporated into these Legal
          Terms. Please be advised the Services are hosted in Latvia. If you
          ...
          disclosure that differ from applicable laws in Latvia, then through
          your continued use of the Services, you are transferring your data to
          Latvia, and you expressly consent to have your data transferred to and
          processed in Latvia.
        </RegularLegalParagraph>
      </section>
      <section id="copyright-infringements">
        <RegularLegalHeader>14. COPYRIGHT INFRINGEMENTS</RegularLegalHeader>
        <RegularLegalParagraph>
          We respect the intellectual property rights of others. If you believe
          that any material available on or through the Services infringes upon
      ...
      <section id="termination">
        <RegularLegalHeader>15. TERM AND TERMINATION</RegularLegalHeader>
        <RegularLegalParagraph>
      ...
      <section id="corrections">
        <RegularLegalHeader>18. CORRECTIONS</RegularLegalHeader>
        <RegularLegalParagraph>
      ...
      <section id="disclaimer">
        <RegularLegalHeader>19. DISCLAIMER</RegularLegalHeader>
        <RegularLegalParagraph>
      ...
      <section id="limitations">
        <RegularLegalHeader>20. LIMITATIONS OF LIABILITY</RegularLegalHeader>
        <RegularLegalParagraph>
          IsqN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE
      ...
      <section id="idemnification">
        <RegularLegalHeader>21. INDEMNIFICATION</RegularLegalHeader>
        <RegularLegalParagraph>
      ...
      <section id="user-data">
        <RegularLegalHeader>22. USER DATA</RegularLegalHeader>
        <RegularLegalParagraph>
      ...
      <section id="miscellaneous">
        <RegularLegalHeader>24. MISCELLANEOUS</RegularLegalHeader>
        <RegularLegalParagraph>
      ...
      <section className="mb-20" id="contact">
        <RegularLegalHeader>26. CONTACT US</RegularLegalHeader>
        <RegularLegalParagraph>
