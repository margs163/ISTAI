...
export default function Hero() {
  return (
    <section className="flex flex-col gap-4 justify-center items-center px-2">
      <Tag className="lg:text-sm lg:px-4 lg:py-2 lg:rounded-3xl to-indigo-500">
        Speak with Confidence
      </Tag>
      <div className="flex flex-col gap-4 lg:gap-5 lg:max-w-[1000px] px-4 md:px-20">
        <h1 className="font-bold text-5xl lg:text-[5rem] text-gray-900 tracking-tighter text-center leading-[1.05]">
          Master <span className="text-gray-900">IELTS</span> Speaking with Real
          Practice
        </h1>
      ...
      <div className="flex flex-row gap-2 items-center justify-center relative w-full mt-8 px-3">
        <Image
          src={tabletImage}
