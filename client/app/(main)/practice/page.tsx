...
export default function page() {
  return (
    <div className="w-full min-h-screen flex flex-col gap-6 bg-gray-50 py-6 font-geist lg:grid lg:grid-cols-[0.5fr_0.8fr_0.5fr] xl:grid-cols-[0.4fr_0.8fr_0.38fr] lg:justify-items-stretch lg:items-stretch lg:gap-6 lg:w-full lg:px-12 xl:px-28 xl:py-8">
